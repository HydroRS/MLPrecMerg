function [train_model] = elm_train_base(train_output,train_predict,Elm_Type, NumberofHiddenNeurons, ActivationFunction)
...
if Elm_Type~=REGRESSION
    ...
    train_model.InputWeight=InputWeight;
     train_model.BiasofHiddenNeurons=BiasofHiddenNeurons;
      train_model.OutputWeight=OutputWeight;
       train_model.ActivationFunction=ActivationFunction;
        train_model.Elm_Type=Elm_Type;
